...
#ifndef LUMAPLUGEDITOR_H
#define LUMAPLUGEDITOR_H
...
/**
    ...
    One or more of these is created by the LumaPlug::createEditor() method,
...
*/
class LumaPlugEditor   : public AudioProcessorEditor,
...
public:
    ...
    */
    LumaPlugEditor (LumaPlug* const ownerFilter);
	...
	void Log(String text) { log_->setText( log_->getText() + text + "\n" ); }
...
private:
    ...
    // handy wrapper method to avoid having to cast the filter to a LumaPlug
    // every time we need it..
    LumaPlug* getFilter() const throw()       { return (LumaPlug*) getAudioProcessor(); }
};
